    ...
    <section className="relative pt-6 pb-14 sm:pt-10 sm:pb-20 overflow-hidden bg-gradient-to-b from-warmBg via-pinkAccent/30 to-warmBg">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Main Course Product & Purchase Card */}
          <div className="w-full max-w-md bg-white rounded-3xl p-5 sm:p-7 shadow-card border border-lightBorder/80 mb-8 relative">

            {/* Discount Ribbon */}
            <div className="absolute -top-3 -right-3 bg-brand-500 text-white font-extrabold text-xs px-3 py-1.5 rounded-full shadow-md uppercase tracking-wider flex items-center gap-1 z-20">
              <span>{hero.discountPercent}</span>
              <span>знижка</span>
            </div>

            {/* Premium course box mockup */}
            <div className="relative mb-5 overflow-hidden rounded-2xl border border-lightBorder bg-gradient-to-b from-brand-50/70 via-white to-pinkAccent/50 px-2 py-2 sm:py-3">
